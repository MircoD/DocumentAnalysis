...
public class Tokenizer {
	 ...
	 * Does not recognize whether an abbreviation is the end of a sentence.
	 * 
	 * @param String containing the text to be split into sentences
	...
	public static String[] splitSentences(String text) {
		...
		for (int i=0;i<sentences.length;i++) {
			// also remove all .,?,! for persistency since our regex already consumes some of them
